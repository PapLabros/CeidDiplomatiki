...
namespace CeidDiplomatiki
{
    ...
    /// </summary>
    internal class PostgreSQLProviderForeignKeyColumn : IDbProviderForeignKeyColumn
    {
        ...
        internal PostgreSQLProviderForeignKeyColumn(DataRow row) : base()
        {
            ...
            OrdinalNumber = row.GetShort(7);
            ConstraintType = row.GetString(8);
        }
        ...
        public override int GetHashCode()
            => HashCodeHelpers.Combine(ConstraintCatalog, ConstraintSchema, ConstraintName, TableCatalog, TableSchema, TableName,
                ColumnName, ReferencedTableSchema, ReferencedTableName, ReferencedColumnName, OrdinalNumber, ConstraintType, OnDelete);
